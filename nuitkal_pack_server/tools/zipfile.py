...
__all__ = ["ZIP_BZIP2", "ZIP_DEFLATED", "ZIP_LZMA", "ZIP_STORED", "BadZipFile", "BadZipfile", "LargeZipFile", "Path", "PyZipFile", "ZipFile", "ZipInfo", "error", "is_zipfile"]
        ...
        while len(extra) >= 4:
            ...
            if tp == 0x0001:
                ...
                if self.header_offset == 0xFFFFFFFF:
                    ...
                    old = self.header_offset  # noqa: F841
