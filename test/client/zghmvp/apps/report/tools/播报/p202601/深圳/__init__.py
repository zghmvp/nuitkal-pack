        ...
        城市维度方案 = self.get_config_by_day(
            self.data_date,
            {
                "default": {
                    ...
                    "准时达标站日次": {"分数": [-5, 0], "0": None, "80": None, "100": None},
    ...
    def 运力考核方案(self) -> dict:
        ...
        城市维度方案 = {
            ...
            "非工作日": {
                ...
                "完成单量目标-晚高峰": 0,
                "时段-午高峰": parse_time_range("[09:00-12:00）"),
                "时段-晚高峰": parse_time_range("[16:00-20:00）"),
            },
        }
        return 城市维度方案
